...
<head>
<link rel="stylesheet" href="common/Azulmedia.css" type="text/css" />
<title>Admin</title>
</head>
<body>
<div id="wrap">
  <div id="header">
    <h1 id="logo">Bwin-Kor<span class="gray">Admin</span></h1>
    <h2 id="slogan">관리자 모드</h2>
    <div id="menu">
      <ul>
        <li id="current"><a href="http://www.free-css.com/">Home</a></li>
        <li ><a href="http://www.free-css.com/">사용자관리</a></li>
        <li><a href="http://www.free-css.com/">게임관리</a></li>
        <li><a href="http://www.free-css.com/">배팅관리</a></li>
        <li><a href="http://www.free-css.com/">등등</a></li>
      </ul>
    </div>
  </div>
  <div id="content-wrap">
