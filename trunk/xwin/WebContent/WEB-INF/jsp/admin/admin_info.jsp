...
//-->
	...
	<tr>
		<td bgcolor="#FFFFFF"><img src="/admin_mode/images/admin/leftm_icon.gif" width="9" height="9"><a href="adminInfo.aspx?mode=viewAdminInfo"> 관리자정보관리</a></td>
    </tr>
</table></td>
              </tr>
          </table>
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <!-- 서버 타이틀 -->
				  <tr>
                    <td height="30" background="/admin_mode/images/admin/tit_bg.gif" style="padding-left:15px" class="sub_tit"> 관리자정보관리</td>
                  </tr>
                  <tr>
