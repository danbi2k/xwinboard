	...
	<tr><td>입금예정액</td>
		...
		<td><table width="100%" cellpadding="0" cellspacing="0"><tr>
			...
			<td>
				...
				<td><span style="width:48;height:16;background:url('images/btn_money_bg.gif');color:white;font-size:11px;text-align:center;padding-top:2;margin-right:5;cursor:hand" onclick="frm.money.value='700000';frm.name.focus();">80만원</span></td>

				<td><span style="width:48;height:16;background:url('images/btn_money_bg.gif');color:white;font-size:11px;text-align:center;padding-top:2;margin-right:5;cursor:hand" onclick="frm.money.value='800000';frm.name.focus();">90만원</span></td>
