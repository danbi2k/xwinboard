...
<tr><td valign="top" align="center" height="300">
	...
	<tr><td>
		...
		<tr><td><img src="images/tab_outmoney.gif"		 onclick="location.href='moneyOut.php?mode=viewMoneyOutRequest'" style="cursor:hand;"></td>
			<td><img src="images/tab_outmoney_list.gif" onclick="location.href='moneyOut.php?mode=viewMoneyOutRequestList'" style="cursor:hand;filter:gray();" hspace="3"></td>
		</tr></table>
