...
<tr><td valign="top" align="center" height="300">
	...
	<tr><td>
		...
		<tr><td><img src="images/tab_inmoney.gif"		onclick="location.href='moneyIn.php?mode=viewMoneyInRequest'" style="cursor:hand;filter:gray();"></td>
			<td><img src="images/tab_inmoney_list.gif" onclick="location.href='moneyIn.php?mode=viewMoneyInRequestList'" style="cursor:hand;" hspace="3"></td>
		</tr></table>
	</td></tr>
	</table>
...
{
	location.href="moneyIn.php?mode=viewMoneyInRequestList&pageIndex=" + index;
}
...
function cancelMoneyInRequest(id)
{
	if (confirm("충전 신청을 취소 하시겠습니까?")) {
		...
		query += "&id=" + id;
		var http = new JKL.ParseXML("moneyIn.php", query);
