	...
	<tr height='32' align="center">
		...
		<td style='border-bottom:1 #b4b4b4 solid;color:#45BCD7' class='board_list' align="left">
			<span style="width:100%;color:#45BCD7;height:15;overflow:hidden;">
				<b><a class="board_list" style="color:#45BCD7;" href="board.php?mode=viewBoardDetail&boardName=<%=boardName%>&id=<%=boardItem.getId()%>">
...
%>
    ...
    <td style='border-bottom:1 #b4b4b4 solid;' class='board_list' align="left">
		...
		<a class="board_list" href="board.php?mode=viewBoardDetail&boardName=<%=boardName%>&id=<%=boardItem.getId()%>&pageIndex=<%=pageIndex%>"><%=boardItem.getTitle()%><b>&nbsp;&nbsp;[<%=boardItem.getCommentCount()%>]</b></a>
		</span>
	</td>
...
<tr><td width="50%" height="30">
    ...
    <td width="50%" height="30" align="right">
        ...
        <a href="board.php?mode=viewBoardWriteForm&boardName=<%=boardName%>"><img src="images/btn_write.gif" border="0"></a>
		<%} %>
    </td></tr>
</table>
...
{
	location.href="board.php?mode=viewBoard&boardName=<%=boardName%>&pageIndex=" + pageIndex;
}
</script>
