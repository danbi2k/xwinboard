...
<form name='search' method='get' action='adminQna.php'>
...
%>
	<tr>
		...
		<td width=*>&nbsp;&nbsp;<a href="adminQna.php?mode=viewQnaDetail&id=<%=boardItem.getId()%>">
...
function saveQnaIsChecked(cobj)
{
	...
	var http = new JKL.ParseXML("adminQna.php", query);
