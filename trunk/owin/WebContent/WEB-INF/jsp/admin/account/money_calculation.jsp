...
<%@ page import="java.util.*"%>
 ...
 <%@ include file="../admin_header.jsp"%>
	...
	<tr>
		<td bgcolor="#FFFFFF"><img src="images/admin/leftm_icon.gif" width="9" height="9"><a href="adminAccount.php?mode=viewMoneyIn"> 입금현황</a></td>
    </tr>
	<tr>
		<td bgcolor="#FFFFFF"><img src="images/admin/leftm_icon.gif" width="9" height="9"><a href="adminAccount.php?mode=viewMoneyOut"> 환전현황</a></td>
    </tr>
	<tr>
		<td bgcolor="#FFFFFF"><img src="images/admin/leftm_icon.gif" width="9" height="9"><a href="adminAccount.php?mode=viewMoneySummary"> 내역관리</a></td>
    </tr>
	<tr>
		<!-- td bgcolor="#FFFFFF"><img src="images/admin/leftm_icon.gif" width="9" height="9"><a href="adminAccount.php?mode=viewMoneyCalculation"> 입출금 정산</a></td-->
    </tr>
</table></td>
              </tr>
          </table>
