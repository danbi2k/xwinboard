...
<form method='post' name='update' action='adminBoard.php'>
...
function writeBoardComment()
{
	...
	var http = new JKL.ParseXML("adminBoard.php", query);
...
{
	if (confirm("삭제하시겠습니까?")) {
		location.href='adminBoard.php?mode=deleteBoardItem&id=<%=boardItem.getId()%>&grade=<%=boardItem.getGrade()%>';
	}
}
</script>
