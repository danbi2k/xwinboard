...
<form name='search' method='get' action='adminBoard.php'>
...
%>
	<tr>
		...
		<%} %>
		<td width=*>&nbsp;&nbsp;<a href="adminBoard.php?mode=viewBoardDetail&id=<%=boardItem.getId()%>"><%=boardItem.getTitle()%>&nbsp;&nbsp;[<%=boardItem.getCommentCount()%>]</a></td>
...
<input type="button" value="쓰기" onclick="location.href='adminBoard.php?mode=viewWriteNotice&grade=<%=grade%>'"/>
<script>
