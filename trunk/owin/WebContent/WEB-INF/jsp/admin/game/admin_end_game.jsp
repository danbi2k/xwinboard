...
<input type="button" value="등록하기" onclick="location.href='adminGame.php?mode=viewRegisterGameForm&type=<%=type%>&grade=<%=grade%>'">
<br>
<br>
<form method='get' name='search' action='adminGame.php'>
...
<form method='get' name='game'>
	<table class="prettytable">
		...
		%>
 		<tr>
			<td width=5%><a href="adminGame.php?mode=viewReprocessGame&id=<%=game.getId()%>&type=<%=game.getType()%>&grade=<%=game.getGrade()%>"><%=game.getId()%></a></td>
