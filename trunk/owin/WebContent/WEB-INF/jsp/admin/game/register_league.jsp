...
<form name='regist' action="adminLeague.php" method='post' enctype="multipart/form-data">
...
<table width="2%"  border="0" cellspacing="5" cellpadding="0">
	<tr>
		...
		<td><img src="images/admin/but_cancel.gif" border="0" onClick="location.href='adminLeague.php?mode=viewLeagueList'" style="cursor:hand"></td>
	</tr>
</table>
