...
<SCRIPT LANGUAGE="JavaScript">
	...
	function delIT(id) {
		if(confirm('리그를 삭제하시겠습니까?')) {
			...
			query += "&id=" + id;
			var http = new JKL.ParseXML("adminLeague.php", query);
			var result = http.parse();
			alert(result.resultXml.message);

			location.href = "adminLeague.php?mode=viewLeagueList";
		}
	}
</SCRIPT>

<div class="title">리그관리</div>
<input type="button" value="등록하기" onclick="location.href='adminLeague.php?mode=viewRegisterLeagueForm'">
<br>
<br>

<form method='post' name='search' action='adminLeague.php'>
