...
<div id="wrapper">
	<div id="header">
		<h1><a href="adminQna.php?mode=viewQnaList&grade=10">OkBet</a></h1>
	</div>
	<div id="pages">
		<h2>Pages</h2>
		<ul>
			<li class="active">충전 <a id="chargingIndi" href="adminAccount.php?mode=viewMoneyInList&status=MC001">0</a></li>
			<li>환전 <a id="exchangeIndi" href="adminAccount.php?mode=viewMoneyOutList&status=ME001">0</a><span style='font-size:12;' id='exPlay' onclick='changeExPlay()'><%=EX_PLAY%></span></li>
			<li>고객센터  <a id="centerIndi" href="adminQna.php?mode=viewQnaList&grade=1">0</a></li>
			<li>VIP센터  <a id="vipIndi" href="adminQna.php?mode=viewQnaList&grade=10">0</a></li>
			<li>해킹  <a id="hackingIndi" href="adminLog.php?mode=viewHackingLog">0</a></li>
		</ul>
	</div>
	<div id="content">
		<div id="posts">
