...
%>
					...
					<tr >
						...
						<td colspan=4 bgcolor="#FFFFFF">
							<input type=radio name=Status value="1" <%=gSelection(Status,1,"checked")%> > 배팅
					...
					<tr >
						...
						<td colspan=4 bgcolor="#FFFFFF"><input type=text name=rtel size=20 value="<%=rtel%>" title="경기결과" MaxBytes="100" class=text></td>
					</tr>
					<% End If %>
					<tr >
						...
						<td bgcolor="#FFFFFF">
							<table border=0>
								<tr>
								<% For i=1 To 38 %>
									<td><input type=radio name=hcont value="<%=i%>" <%If hcont=i Then %> checked <%End If%>><img src="/flag/<%=right("0"&i,2)%>.gif" width=22 height=14></td>
								<% 
						...
						<td bgcolor="#FFFFFF">
							<table border=0>
								<tr>
								<% For i=1 To 38 %>
									<td><input type=radio name=vcont value="<%=i%>" <%If vcont=i Then %> checked <%End If%>><img src="/flag/<%=right("0"&i,2)%>.gif" width=22 height=14></td>
								<% 
								If i mod 6=0 Then Response.Write "</tr><tr>"
								Next 
								%>
