...
SQL = "SELECT DISTINCT gCnt FROM BetGame_TB WHERE ResuFlag='"& Sect &"' And Visbled=0 And Sect=5 "
			...
			<td height="54" background="/Images/Admin/top2_bg.gif" align="left" valign="middle">
				<table border="0">
					<tr>
						...
						<td><font color="#ffffff" size="4"><b>[승무패 <%=tit%> 관리]</b></font></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td align="center">
				<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#aaaaaa" align=center>
					<form name=regfrm method=post action="bMem2.asp">
...
%>
		...
		<input type=hidden name=KeyField value="<%=KeyField%>">
		<input type=hidden name=KeyWord value="<%=KeyWord%>">
		<input type=hidden name=ThisPage value="bMem2.asp">
		<input type=hidden name=flag value="HITUPDATE">
		<tr><td align=center><input type=submit value="적중유무 일괄변경" onclick="UpdateGoldhit();" id=submit3 name=submit3></td></tr>
		</form>
		<tr>
			<td height=50>
