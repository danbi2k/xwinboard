																			...
																			<tr>
																				<td >
																					<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor=D6C5AD>
																						<tr bgcolor=DE6B8C >
																							<td  width=210 align=center ><font color=FFFFFF><b>경기일시</td>
...
%>																						
																						<tr>
																							...
																							<td align=center bgcolor=FFFFF7 ><nobr><%=objRs("hCap")%><span id="handicap_<%=objRs("Idx")%>" style="display:none"><%=objRs("HcapAllotl")%></span></td>
																				...
																				<td bgcolor=FFFFFF>
																					<table border=0 align=center cellpadding=1 cellspacing=2 >
																						<tr  >
																							...
																							<td ><img src=/images/btn_bat.gif onclick="betting('betting')" style="cursor:pointer"></td>
																						</tr>
																						<tr  >
