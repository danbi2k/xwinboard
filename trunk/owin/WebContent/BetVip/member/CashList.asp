																...
																<tr>
																	<td>
																		<table border="0" cellpadding="0" cellspacing="0" >
																			<tr>
																				<td><input type=button class="btn13" value="캐쉬환전 요청" onclick="location.href='Cash.asp';" id=button1 name=button1>&nbsp;</td>
																				<td><input type=button class="btn11" value="캐쉬환전 내역"  id=button2 name=button2></td>
																			</tr>
																		</table>
																	</td>
																</tr>
																				...
																				<td >
																					<table width="100%" border="0" cellspacing="0" cellpadding="0">
																						...
																						<tr align="center" height="30" bgcolor=212021> 
																							...
																							<td width="200"><font color=FFFFFF><b>충전금액</td>
																							<td width="200" ><font color=FFFFFF><b>입금자명</td>
																							<td width="200" ><font color=FFFFFF><b>충전날짜</td>
...
<%
																						If objRs.EOF or objRs.BOF Then
																							Response.Write "<tr><td height=500 align=center colspan=20 >등록된 자료가 없습니다.</td></tr>"
																						Else
																						    Dim count : count = 0
...
%>																					
																						<tr height=27 align=center bgcolor=212021>
																							...
																							<td align=center width=80> <%If objRs("Status")=1 Then %><b><font color=FFC602>충전완료<%Else%>충전대기<%End If%></td>
																						</tr>
