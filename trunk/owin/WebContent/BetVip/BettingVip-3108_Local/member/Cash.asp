																	...
																	<td>
																		<table border="0" cellpadding="0" cellspacing="0" >
																			<tr>
																				...
																				<td><input type=button class="btn13" value="포인트->캐쉬전환" style="width:120" <% If reInt(Session("APoint"),0) >= 20000 Then %> onclick="if(confirm('포인트를 캐쉬로 전환 하시겠습니까?')){location.href='ChCash_Prc.asp';}" <% Else %> onclick="alert('포인트를 캐쉬로 전환은 20,000 이상일떄 전환됩니다.');" <%End If %> ></td>
																			</tr>
