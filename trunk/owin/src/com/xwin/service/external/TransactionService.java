...
{
	private static final String SERVER_URL = "http://bethit.net:10180/external.php?mode=setTransaction";
	//private static final String SERVER_URL = "http://localhost:8080/xwin/external.php?mode=setTransaction";
