...
setInterval(thisReload, 180000);
			...
			<tr><td><img src="img/menu0<%=img%>.jpg" border="0" <%if (member.getMemberId() == 1) {%>onclick="location.href='game.aspx?mode=viewGameList&type=<%=type%>&grade=<%=grade%>&memberId=<%=member.getMemberId()%>'"<%}%>></td></tr>
