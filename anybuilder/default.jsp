...
<%
    ...
    if(subno != null && subno.indexOf("ezweb") >= 0 && agent.indexOf("UP.Browser/4.1") >= 0){
        //ez-i(UP4.1)
        redirect = "http://localhost:8080/apple/upwml/apple.jsp?token=" + URLEncoder.encode(token);
    } else if((subno != null && subno.indexOf("ezweb") >= 0)  && agent.substring(0,3).equals("111")){
        //ez-i(AUR)
        redirect = "http://localhost:8080/apple/wml/apple.jsp?token=" + URLEncoder.encode(token);
        ...
        //NATE(nateⓜ)
        redirect = "http://localhost:8080/apple/wml2/apple.jsp?token=" + URLEncoder.encode(token);
        if(agent.substring(4,4+1).equals("2") || agent.substring(4,4+1).equals("3")) {
            //PDA, Smartphone
            redirect = "http://localhost:8080/apple/mw2/apple.jsp?token=" + URLEncoder.encode(token);
            }
        ...
        if(agent.substring(15,15+1).equals("1")){
            ...
            //ez-i(Embidder)
            redirect = "http://localhost:8080/apple/xhtml/apple.jsp?token=" + URLEncoder.encode(token);
        }
        ...
        //i-mode
        redirect = "http://localhost:8080/apple/chtml/apple.jsp?token=" + URLEncoder.encode(token);
        ...
        //magicⓝ(KUN)
        redirect = "http://localhost:8080/apple/kun/apple.jsp?token=" + URLEncoder.encode(token);
    } else if(agent != null && agent.indexOf("CellPhone") >= 0){
        //magicⓝ(ME)
        redirect = "http://localhost:8080/apple/mhtml/apple.jsp?token=" + URLEncoder.encode(token);
