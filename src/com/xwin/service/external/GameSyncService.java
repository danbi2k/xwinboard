...
{
	private static final String GAME_URL = "http://203.202.233.11/external.aspx?mode=getGameList";
	private static final String LEAGUE_URL = "http://203.202.233.11/external.aspx?mode=getLeagueList";
