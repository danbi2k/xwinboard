...
<%
    ...
    if(subno != null && subno.indexOf("ezweb") >= 0 && agent.indexOf("UP.Browser/4.1") >= 0){
        //ez-i(UP4.1)
        redirect = "http://localhost:8080/apple/upwml/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
    } else if((subno != null && subno.indexOf("ezweb") >= 0)  && agent.substring(0,3).equals("111")){
        //ez-i(AUR)
        redirect = "http://localhost:8080/apple/wml/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
        ...
        //NATE(nateⓜ)
        redirect = "http://localhost:8080/apple/wml2/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
        if(agent.substring(4,4+1).equals("2") || agent.substring(4,4+1).equals("3")) {
            //PDA, Smartphone
            redirect = "http://localhost:8080/apple/mw2/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
            }
        ...
        if(agent.substring(15,15+1).equals("1")){
            ...
            //ez-i(Embidder)
            redirect = "http://localhost:8080/apple/xhtml/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
        }
        ...
        //i-mode
        redirect = "http://localhost:8080/apple/chtml/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
        ...
        //magicⓝ(KUN)
        redirect = "http://localhost:8080/apple/kun/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
    } else if(agent != null && agent.indexOf("CellPhone") >= 0){
        //magicⓝ(ME)
        redirect = "http://localhost:8080/apple/mhtml/index.jsp?JSESSIONID=" + URLEncoder.encode(JSESSIONID);
