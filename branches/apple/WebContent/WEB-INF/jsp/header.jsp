...
<div id='wrap'>
	<div id='header'>
		...
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="900" height="57" id="menu" align="middle">
			...
			<param name="movie" value="swf/menu2.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" />	<embed src="./swf/menu2.swf" quality="high" bgcolor="#ffffff" width="900" height="57" name="menu" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer" />
			</object>
		</div>
	</div>
	<!-- end header -->
