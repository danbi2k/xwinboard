...
<tr><td align="center">
	...
	<tr><td width="100"><img src="images/title_provision.gif"></td><td>이용약관 입니다.</td></td>
...
<tr><td valign="top" align="center">
	...
	<tr bgcolor="#202020"><td><b>7</b></td><td>
		회원은 자신에 배팅머니를 24시간 언제든지 인출을 요구할 수 있으며, 회사는 이러한 일들을 신속하게 처리할 것이다.
	</td></tr>
	...
	<tr bgcolor="#202020"><td><b>10</b></td><td>
		...
		회사는 일부 악의 적인 회원에 대해 언제든지 계정을 취소 또는 정지 시킬 수 있는 권리가 있으며, 이때 보유 머니는 모두 소진될 것이다.<br>
		그러나 회원 스스로 회원 자격을 버릴 경우 자신의 보유 머니를 언제든지 신청하여 인출 할 수 있다.
	</td></tr>
