...
<% } %>
    ...
    <body id ="card1">
        <div><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr><td height="19" align="center" valign="middle" style="background-color:#8EC7FF;color:#000000">?<%=request.getParameter("type").equals("wdl")?"승무패(최신폰)":request.getParameter("type").equals("mix")?"스페셜(최신폰)":"핸디캡(최신폰)"%>?</td></tr>
            <tr><td height="1" style="background-color:#D9D9FF"></td></tr>
        </table></div>
