		...
		<div id="game" class="boxed">
			...
			<div class="content">
				<ul>
					...
					<li><a href="adminGame.aspx?mode=viewGameList&type=handy&grade=<%=Code.USER_GRADE_VIP%>">이벤트</a></li>
					...
					<li><a href="adminGame.aspx?mode=viewEndGameList&type=handy&grade=<%=Code.USER_GRADE_VIP%>">경기결과(이벤트)</a></li>
