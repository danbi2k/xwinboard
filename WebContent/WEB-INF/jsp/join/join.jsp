...
<%@include file="../header.jsp"%>
 ...
 <table align="center" cellpadding="0" cellspacing="0" width="771" height="213">
	...
	<tr>
        <td width="771" height="100%" background="img/minit_02.jpg" valign="top" style="padding:20">
		<span style="width:100%;height:100%;OVERFLOW:auto">
<b style='color:white'>1.</b><%=SiteConfig.SITE_NAME%>(이하 회사)는 회원님이 계정을 가지고 있을 때 아래의 내용에 동의 한다고 가정합니다.<br>
