...
<% } %>
    ...
    <body id ="card1">
        <div><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr><td height="19" align="center" valign="middle" style="background-color:#8EC7FF;color:#000000">?<%=request.getParameter("type").equals("wdl")?"승무패":request.getParameter("type").equals("mix")?"스페셜":"핸디캡"%>?</td></tr>
            <tr><td height="1" style="background-color:#D9D9FF"></td></tr>
        </table></div>
...
if (weblike.equals("true")) {
%>
        <div><span style="color:#CC00FF;">※ 12시간 이내 경기만 표시됨</span></div>
