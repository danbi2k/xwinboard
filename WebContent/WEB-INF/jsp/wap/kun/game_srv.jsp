...
<html>
    <head>
    <title>?<%=request.getParameter("type").equals("wdl")?"승무패":request.getParameter("type").equals("mix")?"스페셜":"핸디캡"%>?</title>
...
<% } %>
    ...
    <body>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr><td height="19" align="center" bgcolor="#8EC7FF"><font color="#000000">?<%=request.getParameter("type").equals("wdl")?"승무패":request.getParameter("type").equals("mix")?"스페셜":"핸디캡"%>?</font></td></tr>
...
%>
            ...
            <table width="100%" bgcolor="#FFFFBB" border="0" style="background-color:#FFFFBB;border-width:0;border-color:#0000FF;border-collapse:collapse;">
                <tr>
                    ...
                    <td bgcolor="#FFFFBB" style="border-width:0;border-color:#0000FF;background-color:#FFFFBB;">
                        <div><input type="text" name="money" value="<%=money%>" format="1" onchange="change_money(this)" /></div>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFBB" style="border-width:0;border-color:#0000FF;background-color:#FFFFBB;">
                    ...
                    <td bgcolor="#FFFFBB" style="border-width:0;border-color:#0000FF;background-color:#FFFFBB;">
                        <div><input type="text" name="rate" value="<%=rate%>" format="a" disabled /></div>
                    </td>
                </tr>
                <tr>
                    <td bgcolor="#FFFFBB" style="border-width:0;border-color:#0000FF;background-color:#FFFFBB;">
